...
# Import data
df = pd.read_csv(r'C:\Users\MY PC\Desktop\Tech\Ml&AI\Data analytics\projects\medical_examination .csv')
...
def draw_heat_map():
    ...
    ax = sns.heatmap(corr, linewidths=.5, annot=True, fmt='.1f', mask=mask, vmin=-0.1, vmax=0.25, center=0, square=True, cbar_kws={'shrink':.45, 'format':'%.2f'})
    plt.show()
